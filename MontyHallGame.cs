...
public class MontyHallGame
{
    ...
    public void CriarPortas()
    {
        ...
        this.portaPremiada = new Random().Next(1, 3);

        // Escolhe uma porta.
        this.portaEscolhida = new Random().Next(1, 3);

        // Abre uma porta.
        this.portaRevelada = new[] { 1, 2, 3 }.Except(new[] { portaEscolhida, portaPremiada }).First();
